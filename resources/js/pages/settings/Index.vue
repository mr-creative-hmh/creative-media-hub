...
<template>
    ...
    <AppLayout v-slot="{ play }">
        ...
        <!-- Success Alert -->
        <div v-if="showSuccess" class="glass-panel p-4 rounded-2xl border border-emerald-500/40 bg-emerald-950/20 text-emerald-300 text-xs font-bold flex items-center gap-2 mb-6">
        ...
        <div class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-[10px] text-cyan-400 font-bold bg-cyan-500/10 px-2 py-0.5 rounded">
                        ...
                        <input
                            ...
                            class="w-full h-11 rounded-xl bg-white/[0.04] border border-white/15 px-4 text-xs text-slate-100 font-mono focus:border-cyan-500 outline-none"
                        />
                    </div>
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-[10px] text-indigo-400 font-bold bg-indigo-500/10 px-2 py-0.5 rounded">
                    ...
                    <div class="space-y-2 md:col-span-2">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-[10px] text-emerald-400 font-bold bg-emerald-500/10 px-2 py-0.5 rounded">
            ...
            <div class="glass-panel rounded-3xl p-6 sm:p-8 border border-white/10 space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                    <div class="p-3.5 rounded-2xl glass-card border border-white/10 flex items-center justify-between">
                        <div>
                            <h4 class="font-bold text-xs text-white">TMDb (The Movie Database)</h4>
                            <p class="text-[10px] text-slate-400 mt-0.5">Arabic & English metadata, 4K backdrops</p>
                        </div>
                        <span class="cinema-badge bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 text-[10px]">Active</span>
                    </div>

                    <div class="p-3.5 rounded-2xl glass-card border border-white/10 flex items-center justify-between">
                        <div>
                            <h4 class="font-bold text-xs text-white">TVMaze (100% Free)</h4>
                            <p class="text-[10px] text-slate-400 mt-0.5">TV seasons, episodes & stills (No Key Required)</p>
                        </div>
                        <span class="cinema-badge bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 text-[10px]">Free Tier</span>
                    </div>

                    <div class="p-3.5 rounded-2xl glass-card border border-white/10 flex items-center justify-between">
                        <div>
                            <h4 class="font-bold text-xs text-white">AniList / Jikan GraphQL</h4>
                            <p class="text-[10px] text-slate-400 mt-0.5">Anime specialist catalog (100% Free)</p>
                        </div>
                        <span class="cinema-badge bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 text-[10px]">Free Tier</span>
                    </div>
                    ...
                    <div class="p-3.5 rounded-2xl glass-card border border-white/10 flex items-center justify-between">
                        <div>
                            <h4 class="font-bold text-xs text-white">Wikipedia & Wikidata</h4>
                            <p class="text-[10px] text-slate-400 mt-0.5">Multilingual encyclopedia synopsis fallback</p>
                        </div>
                        <span class="cinema-badge bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 text-[10px]">Free Tier</span>
                    </div>
                    ...
                    <div class="p-3.5 rounded-2xl glass-card border border-white/10 flex items-center justify-between">
                        <div>
                            <h4 class="font-bold text-xs text-white">Local NFO & XML Reader</h4>
                            <p class="text-[10px] text-slate-400 mt-0.5">Kodi & TinyMediaManager offline files</p>
                        </div>
                        <span class="cinema-badge bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 text-[10px]">Offline</span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="space-y-3 pt-6">
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input
                                ...
                                class="rounded bg-white/10 border-white/20 text-cyan-500 focus:ring-cyan-500"
                            />
                            <span class="text-xs font-bold text-slate-200">{{ t('settings.auto_fetch_meta') }}</span>
                        </label>
                        ...
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input
                                ...
                                class="rounded bg-white/10 border-white/20 text-cyan-500 focus:ring-cyan-500"
                            />
                            <span class="text-xs font-bold text-slate-200">{{ t('settings.auto_fetch_subs') }}</span>
                        </label>
                    </div>
                </div>
            </div>
